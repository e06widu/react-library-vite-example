...
import SingtelTbl from './SingtelTbl';

const meta: ComponentMeta<typeof SingtelTbl> = {
    title: 'Design System/SingtelTbl',
    component: SingtelTbl,
};
export default meta;

export const Primary: ComponentStoryObj<typeof SingtelTbl> = {
    args: {
        data:[
